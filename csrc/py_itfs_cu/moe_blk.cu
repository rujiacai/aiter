...
// hsa/{arch}/moe_blk/. The .co files are produced by hsa/flydsl_export.py and
// are ordinary AMDGPU code objects, so nothing here depends on how they were
// generated -- AiterAsmKernel loads them exactly like the hand-written asm
// kernels.
//
